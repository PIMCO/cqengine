...
queryParameter : NUMERIC_LITERAL | STRING_LITERAL | STRING_LITERAL_WITH_TRAILING_PERCENT | STRING_LITERAL_WITH_LEADING_PERCENT | STRING_LITERAL_WITH_LEADING_AND_TRAILING_PERCENT | BOOLEAN_LITERAL ;
